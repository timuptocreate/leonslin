 ...
 * const authority2 = getAuthority( 'https://leonslinmedia.com:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://leonslinmedia.com:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString1 = getQueryString( 'https://leonslinmedia.com:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://leonslinmedia.com:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
