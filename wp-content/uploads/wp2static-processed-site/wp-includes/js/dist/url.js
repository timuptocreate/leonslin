 ...
 * const authority2 = getAuthority( 'http://127.0.0.1:5500:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'http://127.0.0.1:5500:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString1 = getQueryString( 'http://127.0.0.1:5500:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'http://127.0.0.1:5500:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
